...
int main(int argc, char** argv)
{
    ...
    Mat real_money = imread("D:/Desktop/real.jpg", IMREAD_COLOR);
    Mat fake_money = imread("D:/Desktop/fake.jpg", IMREAD_COLOR);
    Mat torn_money = imread("D:/Desktop/torn.jpg", IMREAD_COLOR);
